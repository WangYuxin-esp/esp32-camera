...
// if you want to use vga jpeg format, you should write reset regs->write vga regs->write common regs->write jpeg regs
...
// xclk = 10M, fps = 20fps.
static const struct xc7082_regval XC7082_vga_yuv422_regs[] = {
    {0xfffd, 0x80},
    {0xfffe, 0x50}, //rewrite page to ensure reg addr is correct
    {0x0030, 0x04},
    {0x0031, 0xdc},
    {0x0032, 0x36},
    {0x0033, 0x90},
    ...
    {0x0022, 0x02},
    {0x0023, 0x85},
    {0x0024, 0x05}, //0x05: 20fps, change to 0x06 can improve frame rates
    {0x0025, 0x06},
    {0x0026, 0x02},
    {0x0027, 0x06},
    {0x0028, 0x01},
...
static const struct xc7082_regval XC7082_svga_yuv422_regs[] = {
    {0xfffd, 0x80},
    {0xfffe, 0x50}, //rewrite page to ensure reg addr is correct
    {0x0030, 0x04},
    {0x0031, 0xdc},
...
static const struct xc7082_regval XC7082_720p_yuv422_regs[] = {
    {0xfffd, 0x80},
    {0xfffe, 0x50}, //rewrite page to ensure reg addr is correct
    {0x0030, 0x04},
    {0x0031, 0xdc},
...
static const struct xc7082_regval XC7082_uxga_yuv422_regs[] = {
    {0xfffd, 0x80},
    {0xfffe, 0x50}, //rewrite page to ensure reg addr is correct
    {0x0030, 0x04},
    {0x0031, 0xdc},
...
static const struct xc7082_regval XC7082_default_Mjpeg_common_regs[] = {
    {XC7082_REG_ADDR_HIGH_8BIT1, 0x80},
    {0xfffe, 0x26},
    {0x2019, 0x05}, //Hsize
    {0x201a, 0x00},
...
static const struct xc7082_regval XC7082_default_Mjpeg_vga_regs[] = {
    {XC7082_REG_ADDR_HIGH_8BIT1, 0x80},
    {0xfffe, 0x2c},
    {0x0048, 0x05}, //Hsize*2
    {0x0049, 0x00},
    {0xfffe, 0x28},          
    {0x01a8, 0x70}, //Control the delay between frames
    {0x01a9, 0x57},
};

static const struct xc7082_regval XC7082_default_Mjpeg_svga_regs[] = {
    {XC7082_REG_ADDR_HIGH_8BIT1, 0x80},
    {0xfffe, 0x2c},
    {0x0048, 0x06}, //Hsize*2
    {0x0049, 0x40},
...
static const struct xc7082_regval XC7082_default_Mjpeg_720p_regs[] = {
    {XC7082_REG_ADDR_HIGH_8BIT1, 0x80},
    {0xfffe, 0x2c},
    {0x0048, 0x0a}, //Hsize*2
    {0x0049, 0x00},
...
static const struct xc7082_regval XC7082_default_Mjpeg_uxga_regs[] = {
    {XC7082_REG_ADDR_HIGH_8BIT1, 0x80},
    {0xfffe, 0x2c},
    {0x0048, 0x0c}, //Hsize*2
    {0x0049, 0x80},
...
static const struct xc7082_regval XC7082_patch_vga_regs[] = {
    //AE
    {0xfffe, 0x30},
    {0x1f00, 0x00},
    ...
    {0x1f06, 0x03},
    {0x1f07, 0xb0}, //win_height
    {0x1f08, 0x03},
    {0x0051, 0x01},

    //Disable jpeg, used to switch jpeg mode to yuv422 mode
    {0xfffe, 0x30},
    {0x0052, 0x00}, //bit[0]:jpeg_sram_share_en
    {0xfffe, 0x31},
    {0x0005, 0x00}, //bit[7]:jpeg_clk_en
    {0xfffe, 0x50},
    {0x00a9, 0x00}, //jpeg_enable
    {0xfffe, 0x26},
    {0x2022, 0x00}, //mipi_tx_jpeg_enable
};

static const struct xc7082_regval XC7082_patch_svga_regs[] = {
    //AE
    {0xfffe, 0x30},
    {0x1f00, 0x00},
    {0x1f01, 0x00}, //win_Xstart
...
static const struct xc7082_regval XC7082_patch_720p_regs[] = {
    //AE
    {0xfffe, 0x30},
    {0x1f00, 0x00},
    {0x1f01, 0x00}, //win_Xstart
    ...
    {0x1f03, 0x00}, //win_Ystart
    {0x1f04, 0x06},
    {0x1f05, 0x40}, //win_width
    {0x1f06, 0x03},
    {0x1f07, 0x74}, //win_height
    {0x1f08, 0x03},
    {0x0051, 0x01},
};

static const struct xc7082_regval XC7082_patch_uxga_regs[] = {
    //AE
    {0xfffe, 0x30},
    {0x1f00, 0x00},
...
// The following is mainly about the improvement of image quality.
static const struct xc7082_regval XC7082_common_regs[] = {
    {0xfffe, 0x2e},	
